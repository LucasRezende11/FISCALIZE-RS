...
###################################################################################################################################
        ...
        for i, row in df_cidade.iterrows():
            fig.add_trace(go.Bar(x=[row['Ano']], y=[0.6], name=row['Ano'], text=f"<b>{row['Partido']}</b>",textposition='inside',hoverinfo="text", marker=dict(color='rgb(55, 83, 109)'),  customdata=[row['Candidato']],
...
###################################################################################################################################
        ...
        st.markdown(
            ...
            <div style='text-align: center; font-size: 22px; margin-top: 10px;'>
                ...
                <span style="font-size: 16px;">(Ano Base - {year})</span>
            </div>
            <hr style="border: 1px solid #ccc; width: 100%; margin: 0; margin-top: 10px; margin-bottom: 10px;">
